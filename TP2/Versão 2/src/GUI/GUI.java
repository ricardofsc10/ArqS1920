...
public class GUI {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\n\nDatabase Not Populated With Market Stocks Due To API Problem\n\n");
        }
    ...
    private static boolean menuHandler(){
        ...
        if (option.equals("1")) {
            ...
            try {
                ...
                System.out.println("\n\nThere Are No Stocks On The Market Due To API Problem\n\n");
            }
            continuar();
            showMenu(ngplt);
        } else {
    ...
    private static void signMenu() {
        ...
        try {
            ...
            System.out.println("User Data Successfully Introduced And Registered !");
            continuar();
            showMenu(ngplt);
